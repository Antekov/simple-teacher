			...
			<div class="content ta-center">
				<form id="login_form" method="post" action="/registration?return=&random=<?=time()?>">
					...
					<div class="input-group input-group-lg">
						...
						<input type="text" class="form-control j-login" name="login" value="<? echo isset($login) ? $login : '' ?>" placeholder="Логин" aria-describedby="basic-addon-login">
					</div>
					<br>
					<div class="input-group input-group-lg">
						<span class="input-group-addon" id="basic-addon-pass"><i class="fa fa-lock"></i></span>
						<input type="password" class="form-control j-pass" name="pass" value="<? echo isset($pass) ? $pass : '' ?>" placeholder="Пароль" aria-describedby="basic-addon-pass">
                    </div>
                    <br>
                    <div class="input-group input-group-lg">
						<span class="input-group-addon" id="basic-addon-pass"><i class="fa fa-lock"></i></span>
						<input type="password" class="form-control j-pass2" name="pass2" value="<? echo isset($pass) ? $pass : '' ?>" placeholder="Пароль еще раз" aria-describedby="basic-addon-pass">
					</div>
					<br>
