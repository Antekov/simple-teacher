...
<div class="row">
    <div class="col-sm-12">
        <h1 class="client-title">
            ...
            <span class="ct-cost"><span class="ctc-cost"><?=$client['data']['cost']?></span><span class="ctc-duration">
                    руб. / <?=$client['data']['duration']?> мин.</span></span>
        </h1>
    </div>
</div>
<?php } ?>
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="input-group input-group-lg">
                ...
                <select class="form-control" name="client_id" value="" placeholder="" autofocus required>
                    <option value="" data-duration="90">...</option>
                    <?php foreach ($clients as $client) { ?>
                    <option value="<?=$client['id']?>" data-duration="<?=$client['data']['duration']?>">
                        <?=$client['name'].' / '.$client['description']?></option>
                    <?php // print_r($client); ?>
                    <?php } ?>
                </select>
            </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="input-group input-group-lg">
                ...
                <input type="number" class="form-control data-duration" value="<?=$lesson['duration']?>"
                ...
                <div class="input-group-btn input-group-lg">
                    <div class="input-group-btn">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            ...
                            <li><a href="#" onclick="$('input.data-duration').val($(this).data('value'));"
                                    data-value="120">2 ч. (120 мин.)</a></li>
                            <li><a href="#" onclick="$('input.data-duration').val($(this).data('value'));"
                                    data-value="150">2,5 ч. (150 мин.)</a></li>
                            <li><a href="#" onclick="$('input.data-duration').val($(this).data('value'));"
                                    data-value="180">3 ч. (180 мин.)</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <button type="button" class="btn btn-default navbar-btn"
                onclick="lessons.save(lessons.id)">Сохранить</button>
        </div>
	</div>
	<?php } ?>
